...
import com.toparchy.molecule.bi.shipBuilding.data.WldzjhRepository;

@Path("/business/wldzjh")
public class WldzjhRESTService {
	@Inject
	private WldzjhRepository repository;
