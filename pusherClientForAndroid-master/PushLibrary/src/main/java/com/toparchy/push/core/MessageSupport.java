...
import com.toparchy.push.entity.ClientInfo;
import com.toparchy.push.entity.GenericMessage;
import com.toparchy.push.nio.ConnectHandler.AfterConnectListener;
import com.toparchy.push.nio.ReadWriteHandler;
import com.toparchy.push.nio.ReadWriteHandler.ChannelReadListener;
import com.toparchy.push.nio.ReadWriteHandler.ChannelWriteListener;
import com.toparchy.push.nio.SimpleEventLoop;
import com.toparchy.push.nio.SimpleEventLoop.STATE;
import com.toparchy.push.utils.DeviceUtil;
import com.toparchy.push.utils.DigestUtils;
import com.toparchy.push.utils.NetWorkUtil;
import com.toparchy.push.utils.PackageUtils;
...
public abstract class MessageSupport implements Receiveable {
	...
	private static int MAX_RECONNCNT = 30;
